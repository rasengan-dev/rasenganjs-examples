...
export default function Input({
  ...
  return (
		<div className={`w-full px-3 ${containerClassName}`}>
			{label && (
				<label className={`text-md font-semibold px-1 border-border`}>
					{label}
				</label>
			)}
			<div className='relative flex items-center'>
				...
				{isTextArea ? (
					<textarea
						...
						} py-2 rounded-lg border-[1px] border-border outline-none focus:border-primary ${className}`}
