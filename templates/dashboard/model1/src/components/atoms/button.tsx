  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        "primary-secondary": "bg-primary/15 text-primary hover:bg-primary/25",
        green: "bg-green text-white hover:bg-green-600",
        "green-secondary": "bg-green/15 text-green hover:bg-green/25",
        yellow: "bg-yellow text-white hover:bg-yellow-600",
        "yellow-secondary": "bg-yellow/15 text-yellow hover:bg-yellow/25",
        red: "bg-red text-white hover:bg-red-600",
        "red-secondary": "bg-red/15 text-red hover:bg-red/25",
