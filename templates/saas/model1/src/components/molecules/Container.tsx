...
export default function Container({
  ...
  return (
    <div className="relative">
      <div
        className={`relative z-10 w-full max-sm:h-full max-md:h-auto flex flex-col md:flex-row items-center justify-between max-w-[1500px] mx-auto px-4 py-7 md:p-7 lg:p-10 min-h-[400px] rounded-2xl   ${
          isDark
            ...
            : `bg-rasengan-light-background text-rasengan-light-text shadow-rasengan-light-shadow ${
                !transparent &&
                'shadow-lg border-[1px] border-rasengan-light-border'
              }`
        } mb-10 ${className}`}
      >
        {children}
