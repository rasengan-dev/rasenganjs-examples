...
import lando_1 from "@/assets/lando-1.png";
...
const Home: PageComponent = () => {
  ...
  const testimonials = [
    ...
    {
      testimonial: "I recommend Lando to any business looking for improvement.",
      ranking: 5,
      author: "Adele Mouse",
    ...
    <section className="">
      <Container className="   mt-5 lg:mt-20" transparent>
        ...
        <div className="relative w-full md:w-3/5 h-[300px] mb-10 md:mb-0 mt-5 md:mt-0">
          <div className="absolute   md:-right-5  top-0  md:top-1/2 md:-translate-y-1/2  ">
            <Image
              src={lando_1}
              alt="Image"
      ...
      <Container className="mb-20 md:mb:30 lg:mb-40  gap-10" variant="double">
          ...
          {steps.map((item, index) => (
            ...
            >
              ...
              <Typography
                ...
                className={`text-[16px] w-4/5 md:w-1/2 text-center md:text-start ${isDark ? "text-gray-400" : "text-gray-600"}`}
              />
            </div>
          ))}
        </div>
      ...
      >
        <div className="flex flex-col items-center md:items-start w-full md:w-2/5">
          <Typography
            text="Get started with Lando today"
            className="text-3xl lg:text-[40px] lg:leading-[50px] mb-4 text-center md:text-start"
            weight="bold"
          />
          <Typography
