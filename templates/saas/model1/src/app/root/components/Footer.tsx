...
export default function Footer() {
	...
	return (
		<footer className={`${isDark ? 'border-rasengan-dark-border bg-rasengan-dark-background text-rasengan-dark-text':'border-rasengan-light-border bg-rasengan-light-background text-rasengan-light-text'} grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 border-t-[1px] w-full max-w-[1500px] mx-auto px-10 lg:px-40 py-10`}>
